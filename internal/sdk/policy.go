...
func newPolicy(sdkConfig sdkConfiguration) *policy {
	return &policy{
...
// Create a policy
func (s *policy) CreateANpaPolicy(ctx context.Context, request operations.CreateANpaPolicyRequest) (*operations.CreateANpaPolicyResponse, error) {
...
func (s *policy) CreateANpaPolicyGroup(ctx context.Context, request operations.CreateANpaPolicyGroupRequest) (*operations.CreateANpaPolicyGroupResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *policy) DeleteANpaPolicy(ctx context.Context, request operations.DeleteANpaPolicyRequest) (*operations.DeleteANpaPolicyResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *policy) GetANpaPolicy(ctx context.Context, request operations.GetANpaPolicyRequest) (*operations.GetANpaPolicyResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/api/v2/policy/npa/rules/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *policy) GetListOfNpaPolicies(ctx context.Context, request operations.GetListOfNpaPoliciesRequest) (*operations.GetListOfNpaPoliciesResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url := strings.TrimSuffix(baseURL, "/") + "/api/v2/policy/npa/rules"
...
func (s *policy) GetListOfNpaPolicyGroups(ctx context.Context, request operations.GetListOfNpaPolicyGroupsRequest) (*operations.GetListOfNpaPolicyGroupsResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url := strings.TrimSuffix(baseURL, "/") + "/api/v2/policy/npa/policygroups"
...
func (s *policy) PatchANpaPolicy(ctx context.Context, request operations.PatchANpaPolicyRequest) (*operations.PatchANpaPolicyResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/api/v2/policy/npa/rules/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
